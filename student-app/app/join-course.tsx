...
export default function JoinCourse() {
  ...
  const params = useLocalSearchParams<{ initialCode?: string }>();
  ...
  const [code, setCode] = useState(params.initialCode ? params.initialCode.toUpperCase().replace(/\s/g, '').substring(0, 10) : '');
              ...
              <View className="bg-white rounded-2xl p-6" style={styles.card}>
                  ...
                  <View className="gap-6">
                    ...
                    <View className="gap-3">
                      ...
                      >
                        ...
                        >
                          {loading ? (
                            ...
                            <>
                              <LogIn size={22} color="#081637" strokeWidth={2.5} />
                              <Text className="text-primary font-bold text-base">Enroll Now</Text>
                            </>
                          )}
                        </LinearGradient>
                      </Pressable>
                      ...
                      <Pressable
                        ...
                        disabled={loading}
                        className="bg-surface border-2 border-outline h-14 rounded-xl items-center justify-center active:bg-slate-100"
                      >
                        <Text className="text-on-surface font-bold text-base">Back</Text>
                      </Pressable>
                    </View>
                  </View>
                )}
                ...
                {state === 'SUCCESS' && (
                  <View className="items-center py-6">
                    <View className="relative items-center justify-center mb-6">
                      <Animated.View
                        style={[
                          ...
                          { position: 'absolute', backgroundColor: '#16A34A' },
                          pingStyle,
                        ]}
                      />
                      <Animated.View
                        style={[
                          styles.successCircle,
                          { transform: [{ scale: successScale }], backgroundColor: '#16A34A' }
                        ]}
                      >
                    ...
                    <Text className="text-3xl font-bold text-primary mb-2 text-center">Enrollment Confirmed!</Text>
                    <Text className="text-base text-on-surface-variant text-center mb-8 px-4 leading-relaxed">
                      You are now enrolled in <Text className="font-bold text-primary">{previewData?.name || code}</Text>
                    </Text>

                    <View className="w-full bg-surface-container rounded-2xl p-4 mb-8 flex-row items-center gap-3">
                      <Info size={24} color="#081637" strokeWidth={2} />
                      <Text className="text-xs text-on-surface-variant flex-1 leading-relaxed font-medium">
                        You'll receive live notifications when your lecturer starts attendance sessions.
                      </Text>
                    </View>
