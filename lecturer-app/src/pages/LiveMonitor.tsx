      ...
      <header className="fixed top-0 left-0 right-0 h-14 border-b border-white/10 px-6 flex items-center justify-between z-40" style={{ backgroundColor: "#081637" }}>
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            <h1 className="text-xs font-bold text-white uppercase tracking-widest" style={{ fontFamily: "var(--font-display)" }}>Real-Time Attendance</h1>
            {activeSession && (
        ...
        <div className="flex items-center gap-2 text-[10px] font-mono uppercase" style={{ color: "#F5B41C" }}>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
          <div className="bg-white dark:bg-[#15181E] rounded-lg border border-slate-200 dark:border-slate-800 p-4">
            ...
            <div className="flex items-baseline gap-1.5">
              <span className="text-3xl font-bold tabular-nums" style={{ color: "#F5B41C" }}>{totalCount}</span>
          ...
          <div ref={tableEndRef} className="overflow-y-auto overflow-x-auto max-h-[480px]">
            {totalCount === 0 ? (
              ...
              <div className="py-16 text-center">
                ...
                <button onClick={() => { setFilter('all'); setSearchQuery(''); }} className="mt-2 text-[10px] font-bold hover:underline uppercase" style={{ color: "#F5B41C" }}>Clear filters</button>
              </div>
            ) : (
