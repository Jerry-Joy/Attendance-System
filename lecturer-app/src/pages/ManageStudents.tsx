    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex justify-between items-end">
        <div>
          ...
          <h1 className="text-xl font-bold text-slate-900 tracking-tight uppercase">Student Roster</h1>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-lg border border-slate-200 p-5 flex flex-col gap-4">
          ...
          <div className="bg-slate-50 rounded-lg border border-slate-300 p-5 text-center">
            <p className="text-[9px] text-slate-500 font-mono uppercase tracking-widest mb-3">Join Code</p>
            <div className="text-2xl font-bold font-mono tracking-[0.2em] text-slate-900 mb-4">{course.joinCode}</div>
          ...
          {students.length > 0 ? (
            <div className="overflow-x-auto">
              <table className="w-full text-left text-sm">
                <thead>
                  <tr className="bg-slate-900/50 text-slate-500 text-[10px] uppercase font-mono tracking-widest border-b border-slate-200">
                ...
                <tbody className="divide-y divide-slate-800/50">
                  {students.map((student, idx) => (
                    <tr key={student.id} className="hover:bg-slate-100 transition-colors group">
                      ...
                      <td className="px-5 py-3 text-xs text-slate-600 font-mono">{student.indexNumber}</td>
                      <td className="px-5 py-3">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-xs font-bold text-slate-900 tabular-nums">{student.attendanceRate}%</span>
                        </div>
                      </td>
            ...
            <div className="flex flex-col items-center justify-center py-20 px-4 text-center">
              ...
              <h2 className="text-sm font-bold text-slate-800 uppercase tracking-widest mb-2">No Enrolled Students</h2>
